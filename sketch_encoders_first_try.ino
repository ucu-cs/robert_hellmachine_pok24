...
#define PIN_SENSOR_SDA_B 13
#define PIN_SENSOR_SCL_B 12
#define PIN_SENSOR_DIR_B 11

#define PIN_SENSOR_SDA_F 10
#define PIN_SENSOR_SCL_F 9
#define PIN_SENSOR_DIR_F 46


AS5600 sensor_f;   //  use default Wire
AS5600 sensor_b;   //  use default Wire
...
void setup() {
  ...
  Wire.begin(PIN_SENSOR_SDA_B, PIN_SENSOR_SCL_B);
  Wire.begin(PIN_SENSOR_SDA_F, PIN_SENSOR_SCL_F);
...
void loop() {
  ...
  Serial.printf("sensor_f angle: %d\n", sensor_f.rawAngle());
